...
package org.elasticsearch.legacy.node.settings;
...
public class NodeSettingsService extends AbstractComponent implements ClusterStateListener {
    ...
    /**
     * Only settings registered in {@link org.elasticsearch.legacy.cluster.settings.ClusterDynamicSettingsModule} can be changed dynamically.
     */
