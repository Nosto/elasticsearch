...
public class RoutingBackwardCompatibilityTests extends ElasticsearchTestCase {
    ...
    public void testBackwardCompatibility() throws Exception {
        ...
        try {
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(RoutingBackwardCompatibilityTests.class.getResourceAsStream("/org/elasticsearch/legacy/cluster/routing/shard_routes.txt"), "UTF-8"))) {
