...
import org.elasticsearch.legacy.index.query.TermQueryBuilder;
import org.elasticsearch.legacy.search.aggregations.bucket.significant.SignificantTerms;
import org.elasticsearch.legacy.search.aggregations.bucket.significant.SignificantTerms.Bucket;
import org.elasticsearch.legacy.search.aggregations.bucket.significant.SignificantTermsAggregatorFactory.ExecutionMode;
...
import org.elasticsearch.legacy.search.aggregations.bucket.significant.heuristics.MutualInformation;
...
public class SignificantTermsTests extends ElasticsearchIntegrationTest {
    ...
    public void nestedAggs() throws Exception {
        ...
        for (org.elasticsearch.legacy.search.aggregations.bucket.terms.Terms.Bucket topCategory : topCategoryTerms.getBuckets()) {
