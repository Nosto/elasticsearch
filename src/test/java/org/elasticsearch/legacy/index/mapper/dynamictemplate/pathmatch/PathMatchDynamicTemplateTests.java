...
package org.elasticsearch.legacy.index.mapper.dynamictemplate.pathmatch;
...
public class PathMatchDynamicTemplateTests extends ElasticsearchTestCase {
    ...
    public void testSimple() throws Exception {
        String mapping = copyToStringFromClasspath("/org/elasticsearch/legacy/index/mapper/dynamictemplate/pathmatch/test-mapping.json");
        DocumentMapper docMapper = MapperTestUtils.newParser().parse(mapping);
        byte[] json = copyToBytesFromClasspath("/org/elasticsearch/legacy/index/mapper/dynamictemplate/pathmatch/test-data.json");
